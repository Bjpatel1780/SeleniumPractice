...
public class TestSuit extends BasePage {
    ...
    public void userShouldBeAbleToLogInSuccessfully(){
        ...
        logInPage.login("xyz0256170902@gmail.com",  "Patel1");
        Assert.assertTrue(Utils.checkIfElementIsDisplayed(By.linkText("Log out")));
        closeBrowser();
    ...
    public void userShouldLogOutSuccessfully(){
        openBrowser();
        homepage.clickOnLogInButton();
        logInPage.login("xyz0217171026@gmail.com",  "Patel1");
